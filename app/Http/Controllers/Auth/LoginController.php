    ...
    */
    ...
    public function login(Request $request): RedirectResponse
    {
        ...
        if(auth()->attempt(array('email' => $input['email'], 'password' => $input['password'])))
        {
            ...
            else if (auth()->user()->type == 'wakild1')
            {
                return redirect()->route('wakild1Home');
            }
            else if (auth()->user()->type == 'wakild2')
            {
                return redirect()->route('wakild2Home');
            }
            else if (auth()->user()->type == 'wakild3')
            {
                return redirect()->route('wakild3Home');
            }
