...
Route::middleware(['auth', 'user-access:wakild1'])->group(function(){
    Route::get('/wakil1/home', [HomeController::class, 'wakild1Home'])->name('wakild1Home');
});
Route::middleware(['auth', 'user-access:wakild2'])->group(function(){
    Route::get('/wakil2/home', [HomeController::class, 'wakild2Home'])->name('wakild2Home');
});
Route::middleware(['auth', 'user-access:wakild3'])->group(function(){
    Route::get('/wakil3/home', [HomeController::class, 'wakild3Home'])->name('wakild3Home');
});
